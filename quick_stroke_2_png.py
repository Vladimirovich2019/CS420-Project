...
def draw_strokes(data: np.array, svg_filename: str, width: int = 256, margin: float = 1.5, color: str = 'black'):
...
def seq_2_pic(datazip, idx:int):
    zipped_files = np.load(datazip, encoding="bytes", allow_pickle=True)
...
if __name__ == "__main__":
    class_dir = "cow"
    seq_2_pic(os.path.join("./data/dataset", f"sketchrnn_{class_dir}.npz"), 2382)
